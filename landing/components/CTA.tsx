    ...
    <section id="download" className="py-20 sm:py-28 bg-deco-primary-dark relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-base text-white/70 leading-relaxed mb-8 max-w-lg mx-auto">
          Whether you&apos;re an athlete looking to grow or a coach managing
          your team&apos;s development — Deco keeps everyone focused on what
          matters.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a
            href="https://github.com/sando-rev/deco/releases/download/v1.2.0/deco-v1.2.0.apk"
            download
        ...
        <p className="text-xs text-white/40 mt-4">
          v1.2.0 &middot; Android APK &middot; iOS version coming soon
        </p>
      </div>
    </section>
  );
